...
xxx_break = [
0, 68.43,94.63,117.74,133.31,140.8]
yyy_break = [
0, 313.525,377.2,455.025,458.2,464.95]
...
# ax.text(-0.1, (2739.3944+24724.1556+500), "2.21x", fontsize=35)
ax.text(0.9, (8421.42), "5.79x", fontsize=35)
ax.text(1.9, (5089.20), "4.84x", fontsize=35)
ax.text(2.9, (3999.80), "4.44x", fontsize=35)
ax.text(3.9, (3050.95), "3.91x", fontsize=35)
ax.text(4.9, (2500.07), "3.76x", fontsize=35)
